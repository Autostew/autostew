...
session_setup_translations = [
    ...
    {'model_field': 'force_identical_vehicles', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'allow_custom_vehicle_setup', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'force_realistic_driving_aids', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'abs_allowed', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'sc_allowed', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'tcs_allowed', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'force_manual', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'rolling_starts', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'force_same_vehicle_class', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'fill_session_with_ai', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'mechanical_failures', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'auto_start_engine', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'timed_race', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'ghost_griefers', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
    {'model_field': 'enforced_pitstop', 'type': 'flag', 'api_field': 'Flags', 'enum_model': SessionFlagDefinition},
