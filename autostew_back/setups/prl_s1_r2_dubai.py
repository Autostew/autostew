...
def make_setup(server):
    ...
    server.session_api.vehicle_class.set_to_game_nice('TC1')
    server.session_api.track.set_to_game_nice("Dubai Autodrome National")
    server.session_api.grid_size.set_to_game(24, for_next_session=True)
    server.session_api.max_players.set_to_game(24)

    server.session_api.weather_slots.set_to_game(0)
    server.session_api.weather_progression.set_to_game(1)
    ...
    server.session_api.tire_wear.set_to_game_nice("X3")
    ...
    server.session_api.date_hour.set_to_game(21)
    server.session_api.date_minute.set_to_game(0)
    server.session_api.date_progression.set_to_game(1)

    server.session_api.practice1_length.set_to_game(45)
    server.session_api.practice2_length.set_to_game(0)
    server.session_api.qualify_length.set_to_game(15)
    server.session_api.warmup_length.set_to_game(5)
    server.session_api.race1_length.set_to_game(25)
