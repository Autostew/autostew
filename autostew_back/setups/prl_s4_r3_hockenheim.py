...
def make_setup(server):
    ...
    server.session_api.track.set_to_game_nice("Hockenheim GP")
    ...
    server.session_api.weather_1.set_to_game_nice("HeavyCloud")
    ...
    server.session_api.date_progression.set_to_game(2)
    ...
    server.session_api.race1_length.set_to_game(27)
