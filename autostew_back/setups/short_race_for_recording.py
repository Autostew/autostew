...
def make_setup(server):
    ...
    server.session_api.practice1_length.set_to_game(5)
    server.session_api.practice2_length.set_to_game(5)
    server.session_api.qualify_length.set_to_game(5)
    server.session_api.warmup_length.set_to_game(5)
    server.session_api.race1_length.set_to_game(1)
