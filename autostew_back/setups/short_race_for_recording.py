...
def make_setup(server):
    ...
    server.session.practice1_length.set_to_game(5)
    server.session.practice2_length.set_to_game(5)
    server.session.qualify_length.set_to_game(5)
    server.session.warmup_length.set_to_game(5)
    server.session.race1_length.set_to_game(1)
